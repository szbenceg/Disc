            ...
            "<div class='message-box'>"+
                ...
                "<div class='text-message-box-container'>" +
                    ...
                    "<div class='send-message-buttons-container'>" +
                        "<button type='button' onclick='removeMessageBox()' class='send-message-button'>Mégsem</buttom>" +
                        "<button type='button' onClick='sendMessage()'class='send-message-button'>Küldés</buttom>" +
                    "</div>" +
                "</div>" +
            "</div>" +
        "</div>"
...
function messageBox(senderId, ownerId){
    $("body").append(
        "<div class='message-container'>" +
            "<div class='message-box'>"+
                "<div class='close-email'>" +
                ...
                "<div class='text-message-box-container'>" +
                    ...
                    "<div class='send-message-buttons-container'>" +
                        "<button type='button' onclick='removeMessageBox()' class='send-message-button'>Mégsem</buttom>" +
                        "<button type='button' onClick='sendMessage(" + senderId + "," + ownerId + ")'class='send-message-button'>Küldés</buttom>" +
                    "</div>" +
                "</div>" +
            "</div>" +
        "</div>"
